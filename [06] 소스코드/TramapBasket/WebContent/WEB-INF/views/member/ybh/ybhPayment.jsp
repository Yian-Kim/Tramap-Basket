...
<head>
  ...
  <title>TramapBasket - Payment</title>
      ...
      <div class="container" style="border: 1px solid black;">
		...
		<div id="selArea">
			...
			<div class="center">
   			...
   			<div class="center">
   				<button type="button" class="btnCard">
	   				<img src="/project/pic/card/bc.jpg"/>
	   				<i class='far fa-check-circle checkGi'></i>
	   				<div class="checkG"></div>
   				</button>
   				<button type="button" class="btnCard">
	   				<img src="/project/pic/card/nh.jpg"/>
	   				<i class='far fa-check-circle checkGi'></i>
	   				<div class="checkG"></div>
   				</button>
   				<button type="button" class="btnCard">
	   				<img src="/project/pic/card/sg.jpg"/>
	   				<i class='far fa-check-circle checkGi'></i>
	   				<div class="checkG"></div>
   				</button>
   				<button type="button" class="btnCard">
	   				<img src="/project/pic/card/sh.jpg"/>
	   				<i class='far fa-check-circle checkGi'></i>
	   				<div class="checkG"></div>
   				</button>
   				
   				<div class="halfD center" style="margin-top: 20px; background: #eee; border-radius: 10px; padding: 10px;">
   					<input type="text" class="form-control" style="width:70%; display: inline-block;" placeholder="카드소유자명" required autofocus/>
   					<input type="text" class="form-control" style="width:70%; display: inline-block;" placeholder="결제카드번호 '-없이'" required/>
   					
   					<input type="text" class="form-control" style="width:30%; display: inline-block;" placeholder="월 '01'" required/>
   					<input type="text" class="form-control" style="width:30%; display: inline-block;" placeholder="년도 '23'" required/>
   					<input type="text" class="form-control" style="width:30%; display: inline-block;" placeholder="시큐리티코드" required/>
   					
   				</div>
   				<div style="margin-top: 10px;">
	   				<button id="next" class="button button-subscribe mr-auto mb-1" type="button">결제</button>
   				</div>
   			</div>
  ...
  <!--================ Start footer Area  =================-->	
	...
	<script>
		$(".btnCard").click(function() {
			$(".btnCard").find('div').css('opacity','0');
			$(".btnCard").find('i').css('opacity','0');
		...
		$("#next").click(function(){
			alert('결제완료');
			location.href='/project/member/ybh/ybhMypage.do?how2=1';
