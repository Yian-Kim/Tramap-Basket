...
font-family: 'BMJUA';
	...
	#tblList th:nth-child(2) { width: 400px; } 
	#tblList th:nth-child(3) { width: 90px; } 
	#tblList th:nth-child(4) { width: 80px; }
	#tblList th:nth-child(5) { width: 140px; }
	#tblList th:nth-child(6) { width: 40px; }
...
<script>
   $(function(){
	   ...
	   $("#selPage").change(function() {
			...
			location.href = "/project/board/bookup/list.do?page=" + $(this).val();
...
<body>
	...
	<div id="boss">
		...
		/project/asset/img/hotel/그랜드 벨라 호텔.jpg
			<!-- 게시판 -->		
			<section id = "detail">	
				<!--	
			<h2 style="align-content: center; padding-left : 750px; margin-top : 50px; margin-bottom: 100px;">교재 추천 게시판</h2>
				-->
			...
			<table id="tblList" class="table table-bordered table-striped long">
				<tr style="background-color: black; ">
					...
					<th style="text-align: center; color:white; font-size: 1.2em;">좋아요</th>
				...
				<tr <c:if test="${dto.notice == 1}">style='background-color:#C8EBFA;'</c:if>>
					...
					<td>					
					<!-- 제목 -->
					<a href="/project/board/bookup/view.do?bookseq=${dto.bookseq}&isSearch=${isSearch}&column=${column}&word=${word}">${dto.subject}</a>
			...
			<!-- 검색 창 -->
			<div id="search">
				<form method="GET" action="/project/board/bookup/list.do">
			...
			<div id="dao" class="btns long">
				...
				<input type="button" value="글쓰기" class="btn btn-danger"
					onclick="location.href='/project/board/bookup/add.do';">
				<%-- </c:if> --%>
			</div>
