...
<body>
	...
	<div id="boss">
		...
		<div class="content" id = "secondcontent">
			...
			<form method="POST" action="/project/board/bookup/addok.do" enctype="multipart/form-data">
			...
			<tr>
				...
				<tr>
					...
					<td style="text-align: center;"><input type="text" name="writer" id="writer" class="form-control" required></td>
				</tr>
				<tr>
					<th style="text-align: center;">가격</th>
					<td style="text-align: center;"><input type="text" name="price" id="price" class="form-control" required></td>
				</tr>
				<tr>
				...
				<input type="button" value="돌아가기" class="btn btn-succes" onclick="location.href='/project/board/bookup/list.do';">
				</div>					
