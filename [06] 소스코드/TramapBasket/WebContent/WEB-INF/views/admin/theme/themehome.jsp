	...
	<section class="section-margin calc-60px">
		<div class="container" style="border: 1px solid black;">
			<div class="section-intro pb-60px">
				<p></p>
				<h2 style="text-align: center;">테마 관리 페이지</h2>
			</div>
			...
			<div class="row">
				...
				<div id="airboard"
					...
					<section id="air">
						...
						<h2 style="text-align: center; margin-bottom: 15px;">테마 목록</h2>
						...
						<table id="tblList" class="table table-bordered long">
							...
							<c:forEach items="${thlist}" var="th">
								...
								<tr>
								<%-- ?seq=${dto.seq} --%>
									<td><a href="/project/admin/theme/edit.do?seq=${th.theme_seq}">${th.name}</a></td>
						...
						<div class="btns" style="float: right; margin-bottom: 20px;">
							<input class="btn btn-default" type="button" value="추가하기" class="control" onclick="location.href='/project/admin/theme/add.do';">
						</div>
