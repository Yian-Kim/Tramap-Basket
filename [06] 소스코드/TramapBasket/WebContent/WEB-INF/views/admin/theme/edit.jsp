	...
	<section class="section-margin calc-60px">
		<div class="container" style="border: 1px solid black;">
			<div class="section-intro pb-60px">
				<p>항공사</p>
				<h2>
					<span class="section-intro__style">추가</span>
				</h2>
			</div>

			<form method="POST" action="/project/admin/theme/editok.do">
				<table id="tblAdd" class="table table-bordered">
					<tr>
						<th>테마이름</th>
						<td><input type="text" name="theme" id="theme"
							class="form-control" required value="${th.name}">${th.name}</td>
					</tr>
				</table>

				<div class="btns">
					<input type="button" value="돌아가기" class="control"
						onclick="location.href='/project/admin/theme/themehome.do';">
					<input type="button" value="삭제하기" class="control"
						onclick="location.href='/project/admin/theme/del.do';">
