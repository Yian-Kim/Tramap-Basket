        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            ...
            <ul class="nav-shop">
              ...
              <li class="nav-item"><a href="/project/home/login">Login</a></li>
            </ul>
          </div>
        </div>
      </nav>
     ...
     <section class="section-margin calc-60px">
      <div class="container" style="border: 1px solid black;">
        <div class="section-intro pb-60px">
          ...
          <h2 class="headname">나라<span class="section-intro__style">수정</span></h2>
        </div>
    		
    		
    		<form method="POST" action="/project/admin/country/editok.do">
				...
				<input type="button" value="돌아가기" class="btn btn-default"
					onclick="location.href='/project/admin/country/countryhome.do';">
   ...
   <!--  <section class="subscribe-position">
    ...
    <div id="basket">
    	...
    	<div class="profile" >
    		...
    		<div id="profilename"><label>관리자(guan)</label></div>
