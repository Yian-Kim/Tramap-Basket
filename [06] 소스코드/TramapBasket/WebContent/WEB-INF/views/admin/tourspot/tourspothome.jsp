	...
	<section class="section-margin calc-60px">
		<div class="container" style="border: 1px solid black;">
			<div class="section-intro pb-60px">
				<p></p>
				<h2 style="text-align: center;">관광지 관리 페이지</h2>
			</div>
			...
			<div class="row">
				...
				<div id="airboard"
					...
					<section id="air">
						...
						<h2 style="text-align: center; margin-bottom: 15px;">관광지 목록</h2>
						...
						<table id="tblList" class="table table-bordered long">
							...
							<c:forEach items="${toslist}" var="tos">
								<!-- items 리스트명 , dto명 / 데이터넣을땐 dto명.~ -->
								<tr>
								<%-- ?seq=${dto.seq} --%>
									<td><a href="/project/admin/tourspot/edit.do?seq=${tos.touristspot_seq}">${tos.name}</a></td>
						...
						<div class="btns" style="float: right; margin-bottom: 20px;">
							<input class="btn btn-default" type="button" value="추가하기" class="control" onclick="location.href='/project/admin/tourspot/add.do';">
						</div>
