...
<style>
    ...
    .picture {
		...
		margin-top: 10px;
		margin-left: 10px;
		/* background-image: url(/Project01/asset/img/${pic}); */
		background-image: url(/Project01/asset/img/copizulzul.jpg);
     ...
     <section class="section-margin calc-60px">
      <div class="container" style="border: 1px solid black;">
        <div class="section-intro pb-60px">
          ...
          <h2 class="headname">항공 티켓<span class="section-intro__style">수정</span></h2>
        </div>
    		
    		
    		<form method="POST" action="/project/admin/airline/editok.do">
				<table id="tblEdit" class="table table-bordered">
					...
					<tr>
						<th>날짜</th>
						<td><input type="text" name="date" class="form-control" value="${dto.issuedate}">${dto.issuedate}</td>
					</tr>
					<tr>
						<th>출발시간</th>
						<td><input type="text" name="starttime" id="time"
							class="form-control" required value="${dto.start_time}">${dto.start_time}</td>
					</tr>
					<tr>
						<th>도착시간</th>
						<td><input type="text" name="arrivetime" id="time2"
							class="form-control" required value="${dto.arrive_time}">${dto.arrive_time}</td>
					</tr>
					<tr>
						<th>좌석등급</th>
						<td>
					...
					<tr>
						...
						<td><input type="text" name="startairport" id="airport"
							class="form-control" required value="${dto.start_airport}">${dto.start_airport}</td>
					</tr>
					<tr>
						<th>도착공항</th>
						<td><input type="text" name="arriveairport" id="airport2"
							class="form-control" required="${dto.arrive_airport}">${dto.arrive_airport}</td>
					</tr>
					<tr>
						<th>가격</th>
						<td><input type="text" name="price" id="price"
							class="form-control" required value="${dto.price}">${dto.price}</td>
					</tr>
				...
				<input type="button" value="돌아가기" class="btn btn-default"
					onclick="location.href='/project/admin/airline/airlinehome.do';">
				<input type="submit" value="수정하기" class="btn btn-default">
				</div>
				
				<input type="hidden" name="seq" value="${dto.faketicket_seq}">
