...
insert into tblTicket(ticket_seq,issuedate,quantity,flight_seq) values (NVL((SELECT MAX(ticket_seq) FROM tblTicket)+1,1), '2019-08-22', 90, 5); 

insert into tblTicket(ticket_seq,issuedate,quantity,flight_seq) values (NVL((SELECT MAX(ticket_seq) FROM tblTicket)+1,1), '2019-08-22', 80, 6); 

insert into tblTicket(ticket_seq,issuedate,quantity,flight_seq) values (NVL((SELECT MAX(ticket_seq) FROM tblTicket)+1,1), '2019-08-22', 70, 7); 

insert into tblTicket(ticket_seq,issuedate,quantity,flight_seq) values (NVL((SELECT MAX(ticket_seq) FROM tblTicket)+1,1), '2019-08-22', 80, 8); 


insert into tblTicket(ticket_seq,issuedate,quantity,flight_seq) values (NVL((SELECT MAX(ticket_seq) FROM tblTicket)+1,1), '2019-08-25', 80, 9); 

insert into tblTicket(ticket_seq,issuedate,quantity,flight_seq) values (NVL((SELECT MAX(ticket_seq) FROM tblTicket)+1,1), '2019-08-25', 70, 10); 

insert into tblTicket(ticket_seq,issuedate,quantity,flight_seq) values (NVL((SELECT MAX(ticket_seq) FROM tblTicket)+1,1), '2019-08-25', 80, 11); 

insert into tblTicket(ticket_seq,issuedate,quantity,flight_seq) values (NVL((SELECT MAX(ticket_seq) FROM tblTicket)+1,1), '2019-08-25', 90, 12); 
